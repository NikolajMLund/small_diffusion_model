...
class KFScenario(BaseScenario):
    ...
    def _compute_projected_inflows(
            self,
            KFScenarioConfig: KFScenarioConfig,
    ) -> np.ndarray:
        # -------------------------------------------
        #   Unpacking and validating dimensions
        # -------------------------------------------
        market_shares=KFScenarioConfig.market_shares
        projected_sales=KFScenarioConfig.projected_sales
    ...
    def get_projected_inflows(self, config: KFScenarioConfig) -> np.ndarray:
